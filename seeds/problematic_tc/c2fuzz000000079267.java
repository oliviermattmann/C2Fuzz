 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000079267::test1
...
public class c2fuzz000000079267 {
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000079267.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
        ...
        v += field0946;
        {
            v += field0947;
            final int Ni1010 = 32;
            for (int i1010 = 1; i1010 < Ni1010; i1010++) {
                v += field0947;
            }
        }
        v += field0948;
    ...
    private static void test1_field1200() {
        ...
        int M4930 = 4;
        int N4930 = 8;
        for (int i4930 = 0; i4930 < M4930; i4930++) {
            {
                int ysnk824 = 0;
                int toSinksnk824 = 0;
                {
    ...
    private static void test1_field1600() {
        ...
        {
            final int N3113 = 32;
            java.lang.Object object3113 = "hot";
            for (int i3113 = 0; i3113 < N3113; i3113++) {
                object3113.toString();
                if (foo21313935727354495(i3113, N3113, 1))
                    v += field1603;

            }
            object3113 = java.lang.Integer.valueOf(1);
            object3113.toString();
            v += field1603;
        }
        v += field1604;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000079267.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
        ...
        public MyInteger(int v) {
            int Ni7448 = 32;
            {
                ...
                for (int peelus4442 = 2; peelus4442 < limitus4442; peelus4442++) {
                    {
                        zerous4442 = 0;
                        final int Ni3838 = 32;
                        for (int i3838 = 1; i3838 < Ni3838; i3838++) {
                            zerous4442 = 0;
                        }
                    } }
                for (int i7448 = 0; i7448 < Ni7448; i7448++) {
                    if (flagus4442)
                        break;
                    if (zerous4442 == 0) if (zerous4442 == 0) {
                        {
                            if (i7448 < 10) {
                                this.v = v;
                            }
            ...
            {
                    {
                        this.v = v;
                        final int Ni4985 = 32;
                        for (int i4985 = 1; i4985 < Ni4985; i4985++) {
                            this.v = v;
                        }
                    }
                final int Ni1456 = 32;
                for (int i1456 = 1; i1456 < Ni1456; i1456++) {
                        {
                            this.v = v;
                            final int Ni1931 = 32;
                            for (int i1931 = 1; i1931 < Ni1931; i1931++) {
                                this.v = v;
                            }
                        }
                }
        ...
        private static boolean foo21313935727354495(int p0, int p1, int p2) {
            return p0 == p1 - p2;
        }
}
