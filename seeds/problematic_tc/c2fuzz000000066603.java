 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000066603::test1
...
public class c2fuzz000000066603 {
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000066603.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
                    ...
                    int toSinksnk8389 = 0;
                    {
                        ...
                        int toSinksnk9293 = 0;
                        {
                            ...
                            for (int j4930 = 0; j4930 < N4930; j4930++) {
                                ...
                                try {
                                    toSinksnk9293 = 23 * (ysnk9293 - 1);
                                } catch (ArithmeticException ex) {
                                    toSinksnk9293 ^= ex.hashCode();
                                }
                                try { toSinksnk8786 = 23 * (ysnk8786 - 1); } catch (ArithmeticException ex) { toSinksnk8786 ^= ex.hashCode(); };
                            }
                            int _sinkUsesnk8786 = toSinksnk8786;;
                        }
    ...
    private static void test1_field1350() {
        ...
        v += field1389;
        v += field1390;
        v += new MyInteger(c2fuzz000000066603.field1391).v();
        v += field1392;
        v += field1393;
        v += field1394;
        v += field1395;
    ...
    private static void test1_field1400() {
        ...
        v += field1414;
        {
            v += field1415;
            final int Ni9072 = 32;
            for (int i9072 = 1; i9072 < Ni9072; i9072++) {
                v += field1415;
            }
        }
        v += field1416;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000066603.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
                ...
                for (int i1456 = 1; i1456 < Ni1456; i1456++) {
                    {
                        this.v = v;
                        final int Ni1773 = 32;
                        for (int i1773 = 1; i1773 < Ni1773; i1773++) {
                            this.v = v;
                        }
                    }
                }
        ...
        public int v() {
            ...
            private static int foo21268339788775776(int p0, int p1, int p2) {
                return p0 * foo21274272216260301(p1, p2) ;
            }

        private static boolean foo21268672930464430(int p0, int p1) {
            return foo21275254639564434(p0, p1);
        }
        ...
        private static boolean foo21275254639564434(int p0, int p1) {
            return p0 < p1;
        }
}
