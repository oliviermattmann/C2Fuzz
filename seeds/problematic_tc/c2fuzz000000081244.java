 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000081244::test1
...
public class c2fuzz000000081244 {
    ...
    private static void test1_field0050() {
        int v = field0050;
        {
            v += field0051;
            final int Ni5706 = 32;
            for (long i5706 = 1L; i5706 < Ni5706; i5706++) {
                v += field0051;
            }
        }
        v += field0052;
    ...
    private static void test1_field0200() {
        ...
        {
            final int N7262 = 32;
            java.lang.Object object7262 = "hot";
            for (int i7262 = 0; i7262 < N7262; i7262++) {
                object7262.toString();
                if (i7262 == N7262 - 1)
                    v += field0241;

            }
            object7262 = java.lang.Integer.valueOf(1);
            object7262.toString();
            v += field0241;
        }
        v += field0242;
    ...
    private static void test1_field0450() {
        ...
        v += field0496;
        v += field0497;
        v += new MyInteger(c2fuzz000000081244.field0498).v();
        v += field0499;
        field0499 = v;
    }
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000081244.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field1600() {
        ...
        v += field1607;
        {
            v += field1608;
            final int Ni4737 = 32;
            for (int i4737 = 1; i4737 < Ni4737; i4737++) {
                v += field1608;
            }
        }
        v += field1609;
    ...
    private static void test1_field1700() {
        ...
        v += field1740;
        {
            v += field1741;
            final int Ni2868 = 32;
            for (int i2868 = 1; i2868 < Ni2868; i2868++) {
                v += field1741;
            }
        }
        v += field1742;
    ...
    private static void test1_field1950() {
        ...
        {
            int limitlz1310 = 2;
            for (; limitlz1310 < 4; limitlz1310 *= 2) { };
            int zerolz1310 = 34;
            for (int peellz1310 = 2; peellz1310 < limitlz1310; peellz1310++) { zerolz1310 = 0; };
            if (zerolz1310 == 0) {
                v += field1985;
            } else {
                v += field1985;
    ...
    private static void test1_field2450() {
        ...
        v += field2499;
        {
            field2499 = v;
            final int Ni284 = 32;
            for (int i284 = 1; i284 < Ni284; i284++) {
                field2499 = v;
            }
        }
    }
    ...
    private static void test1_field3350() {
        ...
        v += field3366;
        {
            v += field3367;
            final int Ni3007 = 32;
            for (int i3007 = 1; i3007 < Ni3007; i3007++) {
                v += field3367;
            }
        }
        v += field3368;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000081244.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
        ...
        public MyInteger(int v) {
            ...
            }
            {
                ...
                final int Ni1456 = 32;
                {
                    boolean flagus5668 = _mutatorFlip();
                    int limitus5668 = 2;
                    for (; limitus5668 < 4; limitus5668 *= 2) { }
                    int zerous5668 = 34;
                    for (int peelus5668 = 2; peelus5668 < limitus5668; peelus5668++) { zerous5668 = 0; }
                    for (int i1456 = 1; i1456 < Ni1456; i1456++) {
                        ...
                        if (zerous5668 == 0) {
                        ...
                        } else {
                            {
                                ...
                                final int Ni2553 = 32;
                                {
                                    boolean flagus6395 = _mutatorFlip();
                                    int limitus6395 = 2;
                                    for (; limitus6395 < 4; limitus6395 *= 2) { };
                                    int zerous6395 = 34;
                                    for (int peelus6395 = 2; peelus6395 < limitus6395; peelus6395++) { zerous6395 = 0; };
                                    for (int i2553 = 1; i2553 < Ni2553; i2553++) {
                                        if (flagus6395)
                                            break;
                                        ...
                                        if (zerous6395 == 0) {
                                            ...
                                            this.v = v;
                                            int _unswitchMarkus6395 = 0;;
                                        }
                                    }
                                }
                            }
                            int _unswitchMarkus5668 = 0;
                        }
                    }
                }
            }
        ...
        private static boolean _mutatorFlip() {
            int M6838 = 4;
            int N6838 = 8;
            for (int i6838 = 0; foo21274273588243635(i6838, M6838); i6838++) {
                {
                    int ysnk3752 = 0;
                    int toSinksnk3752 = 0;
                    for (int j6838 = 0; foo21274181773278616(j6838, N6838); j6838++) {
                        ysnk3752++;
                        switch (i6838) {
                            case -1, -2, -3 :
                                break;
                        ...
                        try {
                                {
                                    toSinksnk3752 = 23 * (ysnk3752 - 1);
                                    final int Ni4825 = 32;
                                    for (int i4825 = 1; i4825 < Ni4825; i4825++) {
                                        toSinksnk3752 = 23 * (ysnk3752 - 1);
                                    }
                                } } catch (ArithmeticException ex) {
                                {
                                    toSinksnk3752 ^= ex.hashCode();
                                    final int Ni397 = 32;
                                    for (int i397 = 1; i397 < Ni397; i397++) {
                                        toSinksnk3752 ^= ex.hashCode();
                                    }
                                } }
                    }
                    int _sinkUsesnk3752 = toSinksnk3752;
                }
            }
            {
                _mutatorToggle = !_mutatorToggle;
                final int Ni8009 = 32;
                for (int i8009 = 1; i8009 < Ni8009; i8009++) {
                    _mutatorToggle = !_mutatorToggle;
                }
            }
        ...
        private static boolean foo21274181773278616(int p0, int p1) {
            return p0 < p1;
        }

        private static boolean foo21274273588243635(int p0, int p1) {
            return foo21275520708743188(p0, p1);
        }

        private static boolean foo21275520708743188(int p0, int p1) {
            return p0 < p1;
        }
    }
}
