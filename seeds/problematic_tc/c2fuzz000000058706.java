 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000058706::test1
...
public class c2fuzz000000058706 {
    ...
    private static void test1_field0050() {
        int v = field0050;
        {
            v += field0051;
            final int Ni5706 = 32;
            for (int i5706 = 1; i5706 < Ni5706; i5706++) {
                v += field0051;
            }
        }
        v += field0052;
    ...
    private static void test1_field0400() {
        ...
        v += field0406;
        {
            v += field0407;
            final int Ni9061 = 32;
            for (int i9061 = 1; i9061 < Ni9061; i9061++) {
                v += field0407;
            }
        }
        v += field0408;
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000058706.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field1100() {
        ...
        v += field1107;
        {
            v += field1108;
            final int Ni6050 = 32;
            for (int i6050 = 1; i6050 < Ni6050; i6050++) {
                v += field1108;
            }
        }
        v += field1109;
    ...
    private static void test1_field1700() {
        ...
        v += field1740;
        {
            v += field1741;
            final int Ni2868 = 32;
            for (int i2868 = 1; foo21291975296221934(i2868, Ni2868); i2868++) {
                v += field1741;
            }
        }
        v += field1742;
    ...
    private static void test1_field3400() {
        ...
        v += field3439;
        {
            v += field3440;
            final int Ni1105 = 32;
            for (int i1105 = 1; i1105 < Ni1105; i1105++) {
                v += field3440;
            }
        }
        v += field3441;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000058706.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
            ...
            {
                {
                    this.v = v;
                    final int Ni4200 = 32;
                    for (int i4200 = 1; i4200 < Ni4200; i4200++) {
                        this.v = v;
                    }
                }
                final int Ni1456 = 32;
                {
                    ...
                    for (int i1456 = 1; i1456 < Ni1456; i1456++) {
                        ...
                        if (zerous5668 == 0) {
                            int M4161 = 4;
                            int N4161 = 8;
                            for (int i4161 = 0; i4161 < M4161; i4161++) {
                                for (int j4161 = 0; j4161 < N4161; j4161++) {
                                    switch (i4161) {
                                        case -1, -2, -3 :
                                            break;
                                        case 0 :
                                ...
                                int M2790 = 4;
                                int N2790 = 8;
                                for (int i2790 = 0; i2790 < M2790; i2790++) {
                                    for (int j2790 = 0; j2790 < N2790; j2790++) {
                                        switch (i2790) {
                                            case -1, -2, -3 :
                                                break;
                                            case 0 :
                        ...
                        } else {
                            {
                                this.v = v;
                                final int Ni1106 = 32;
                                for (int i1106 = 1; i1106 < Ni1106; i1106++) {
                                    this.v = v;
                                }
                            }
            ...
            for (int i6838 = 0; foo21274273588243635(i6838, M6838); i6838++) {
                {
                    ...
                    int toSinksnk3752 = 0;
                    {
                        ...
                        for (int j6838 = 0; foo21274181773278616(j6838, N6838); j6838++) {
                            ...
                            try {
                                toSinksnk3752 = foo21275117315467406(23, ysnk3752, 1);
                            } catch (ArithmeticException ex) {
                                toSinksnk3752 ^= ex.hashCode();
                            }
                            try { toSinksnk1571 = 23 * (ysnk1571 - 1); } catch (ArithmeticException ex) { toSinksnk1571 ^= ex.hashCode(); }
                        }
                        int _sinkUsesnk1571 = toSinksnk1571;
                    }
        ...
        private static boolean foo21274181773278616(int p0, int p1) {
            return foo21274581907189309(p0, p1);
        }
        ...
        private static boolean foo21274581907189309(int p0, int p1) {
            return p0 < p1;
        }

            private static int foo21275117315467406(int p0, int p1, int p2) {
                return p0 * (p1 - p2);
            }
    }

        private static boolean foo21291975296221934(int p0, int p1) {
            return p0 < p1;
        }
}
