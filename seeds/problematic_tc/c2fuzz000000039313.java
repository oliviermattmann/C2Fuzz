 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000039313::test1
...
public class c2fuzz000000039313 {
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000039313.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field1350() {
        ...
        int M7416 = 4;
        int N7416 = 8;
        for (int i7416 = 0; i7416 < M7416; i7416++) {
            for (int j7416 = 0; j7416 < N7416; j7416++) {
                switch (i7416) {
                    case -1, -2, -3 :
                        break;
                    case 0 :
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000039313.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
        ...
        private static boolean _mutatorFlip() {
            int M6838 = 4;
            int N6838 = 8;
            for (int i6838 = 0; i6838 < M6838; i6838++) {
                {
                    int ysnk3752 = 0;
                    int toSinksnk3752 = 0;
                    {
                            ...
                            int toSinksnk2566 = 0;
                            {
                                ...
                                int toSinksnk802 = 0;
                                {
                                    ...
                                    int toSinksnk9759 = 0;
                                    {
                                        int ysnk2667 = 0;;
                                        int toSinksnk2667 = 0;;
                                        for (int j6838 = 0; j6838 < N6838; j6838++) {
                                            ysnk2667++;;
                                            ysnk9759++;
                                            ysnk802++;
                                            ysnk2566++;
                                            ...
                                            try {
                                                toSinksnk2196 = 23 * (ysnk2196 - 1);
                                            } catch (ArithmeticException ex) {
                                                toSinksnk2196 ^= ex.hashCode();
                                            }
                                            try {
                                                toSinksnk2566 = 23 * (ysnk2566 - 1);
                                            } catch (ArithmeticException ex) {
                                                toSinksnk2566 ^= ex.hashCode();
                                            }
                                            try {
                                                toSinksnk802 = 23 * (ysnk802 - 1);
                                            } catch (ArithmeticException ex) {
                                                toSinksnk802 ^= ex.hashCode();
                                            }
                                            try {
                                                toSinksnk9759 = foo21275205076657274(23, ysnk9759, 1);
                                            } catch (ArithmeticException ex) {
                                                toSinksnk9759 ^= ex.hashCode();
                                            }
                                            try { toSinksnk2667 = 23 * (ysnk2667 - 1); } catch (ArithmeticException ex) { toSinksnk2667 ^= ex.hashCode(); };
                                        }
                                        int _sinkUsesnk2667 = toSinksnk2667;;
                                    }
                                    int _sinkUsesnk9759 = toSinksnk9759;
                                }
                                int _sinkUsesnk802 = toSinksnk802;
                            }
                            int _sinkUsesnk2566 = toSinksnk2566;
                        }
                        int _sinkUsesnk2196 = toSinksnk2196;
                    }
            ...
            private static int foo21275205076657274(int p0, int p1, int p2) {
                return p0 * (p1 - p2);
            }
    }
}
