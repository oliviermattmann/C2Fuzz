 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000038032::test1
...
public class c2fuzz000000038032 {
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000038032.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field2250() {
        ...
        v += field2294;
        {
            v += field2295;
            final int Ni912 = 32;
            for (int i912 = 1; foo21268586578693081(i912, Ni912); i912++) {
                v += field2295;
            }
        }
        v += field2296;
    ...
    private static void test1_field3550() {
        ...
        v += field3554;
        {
            v += field3555;
            final int Ni7095 = 32;
            for (int i7095 = 1; foo21273580443004111(i7095, Ni7095); i7095++) {
                v += field3555;
            }
        }
        v += field3556;
    ...
    private static void test1_field3850() {
        ...
        {
            int limitlz9839 = 2;
            for (; limitlz9839 < 4; limitlz9839 *= 2) { }
            int zerolz9839 = 34;
            for (int peellz9839 = 2; foo21274770329696327(peellz9839, limitlz9839); peellz9839++) { zerolz9839 = 0; }
            if (foo21275094127400391(zerolz9839, 0)) {
                v += field3851;
            } else {
                v += field3851;
            }
    ...
    static class MyInteger {
                                    ...
                                    for (long i594 = 1L; i594 < Ni594; i594++) {
                                        ...
                                        ysnk7652++;
                                        {
                                            ...
                                            final int Ni7860 = 32;
                                            {
                                                int ysnk1320 = 0;;
                                                int toSinksnk1320 = 0;;
                                                for (int i7860 = 1; i7860 < Ni7860; i7860++) {
                                                    ysnk1320++;;
                                                    this.v = v;
                                                    try { toSinksnk1320 = 23 * (ysnk1320 - 1); } catch (ArithmeticException ex) { toSinksnk1320 ^= ex.hashCode(); };
                                                }
                                                int _sinkUsesnk1320 = toSinksnk1320;;
                                            }
                                        }
                                        try {
                                        ...
                                        try { toSinksnk7869 = 23 * (ysnk7869 - 1); } catch (ArithmeticException ex) { toSinksnk7869 ^= ex.hashCode(); }
                                    }
        ...
        private static boolean foo21268586578693081(int p0, int p1) {
            return p0 < p1;
        }

        private static boolean foo21273580443004111(int p0, int p1) {
            return p0 < p1;
        }

        private static boolean foo21274770329696327(int p0, int p1) {
            return p0 < p1;
        }

        private static boolean foo21275094127400391(int p0, int p1) {
            return p0 == p1;
        }
}
