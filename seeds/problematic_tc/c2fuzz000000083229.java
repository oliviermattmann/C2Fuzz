 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000083229::test1
...
public class c2fuzz000000083229 {
    ...
    private static void test1_field0050() {
        ...
        v += field0086;
        {
            v += field0087;
            final int Ni4722 = 32;
            for (int i4722 = 1; foo21273339276702291(i4722, Ni4722); i4722++) {
                v += field0087;
            }
        }
        v += field0088;
    ...
    private static void test1_field0350() {
        ...
        v += field0364;
        {
            v += field0365;
            final int Ni6763 = 32;
            for (int i6763 = 1; i6763 < Ni6763; i6763++) {
                v += field0365;
            }
        }
        v += field0366;
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000083229.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field0950() {
        ...
        v += field0971;
        int Ni3885 = 32;
        for (int i3885 = 0; i3885 < Ni3885; i3885++) {
            if (i3885 < 10)
                v += field0972;
    ...
    private static void test1_field1200() {
        ...
        int M4930 = 4;
        int N4930 = 8;
        for (int i4930 = 0; foo21275688097945152(i4930, M4930); i4930++) {
            {
                int ysnk824 = 0;
                int toSinksnk824 = 0;
                {
                    ...
                    int toSinksnk8389 = 0;
                    {
                        int ysnk9293 = 0;;
                        int toSinksnk9293 = 0;;
                        for (int j4930 = 0; j4930 < N4930; j4930++) {
                            ysnk9293++;;
                            ysnk8389++;
                            ysnk824++;
                            switch (i4930) {
                            ...
                            try {
                                toSinksnk824 = foo21268339788775776(23, ysnk824, 1);
                            } catch (ArithmeticException ex) {
                                toSinksnk824 ^= ex.hashCode();
                            }
                            try {
                                toSinksnk8389 = 23 * (ysnk8389 - 1);
                            } catch (ArithmeticException ex) {
                                toSinksnk8389 ^= ex.hashCode();
                            }
                            try { toSinksnk9293 = 23 * (ysnk9293 - 1); } catch (ArithmeticException ex) { toSinksnk9293 ^= ex.hashCode(); };
                        }
                        int _sinkUsesnk9293 = toSinksnk9293;;
                    }
                    int _sinkUsesnk8389 = toSinksnk8389;
                }
                int _sinkUsesnk824 = toSinksnk824;
            }
        }
        v += field1233;
        v += field1234;
    ...
    private static void test1_field2450() {
        ...
        v += field2499;
        {
            field2499 = v;
            final int Ni284 = 32;
            for (int i284 = 1; foo21268672930464430(i284, Ni284); i284++) {
                field2499 = v;
            }
        }
    }
    ...
    private static void test1_field2650() {
        ...
        v += field2695;
        {
            v += field2696;
            final int Ni4031 = 32;
            for (int i4031 = 1; i4031 < Ni4031; i4031++) {
                v += field2696;
            }
        }
        v += field2697;
    ...
    private static void test1_field3100() {
        ...
        v += field3138;
        {
            ...
            final int Ni4801 = 32;
            {
                boolean flagus8288 = _mutatorFlip();
                int limitus8288 = 2;
                for (; limitus8288 < 4; limitus8288 *= 2) { };
                int zerous8288 = 34;
                for (int peelus8288 = 2; peelus8288 < limitus8288; peelus8288++) { zerous8288 = 0; };
                for (int i4801 = 1; i4801 < Ni4801; i4801++) {
                    if (flagus8288)
                        break;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000083229.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
        ...
        public MyInteger(int v) {
            int Ni7448 = 32;
            {
                boolean flagus4442 = _mutatorFlip();
                int limitus4442 = 2;
                for (; limitus4442 < 4; limitus4442 *= 2) { }
                int zerous4442 = 34;
                {
                    boolean flagus4489 = _mutatorFlip();
                    int limitus4489 = 2;
                    for (; limitus4489 < 4; limitus4489 *= 2) { };
                    int zerous4489 = 34;
                    for (int peelus4489 = 2; peelus4489 < limitus4489; peelus4489++) { zerous4489 = 0; };
                    for (int peelus4442 = 2; peelus4442 < limitus4442; peelus4442++) {
                        if (flagus4489)
                            break;
                        ...
                        if (zerous4489 == 0) {
                            ...
                            zerous4442 = 0;
                            int _unswitchMarkus4489 = 0;;
                        }
                    }
                }
                for (int i7448 = 0; i7448 < Ni7448; i7448++) {
                    if (flagus4442)
                        break;
            ...
            }
            {
                this.v = v;
                final int Ni1456 = 32;
                for (int i1456 = 1; i1456 < Ni1456; i1456++) {
                    this.v = v;
                }
            }
        }
        ...
        public int v() {
            ...
            private static int foo21268339788775776(int p0, int p1, int p2) {
                return foo21274911522740076(p0, foo21274272216260301(p1, p2)) ;
            }

        private static boolean foo21268672930464430(int p0, int p1) {
            return p0 < p1;
        }

        private static boolean foo21273339276702291(int p0, int p1) {
            return p0 < p1;
        }

        private static int foo21274272216260301(int p0, int p1) {
            return p0 - p1;
        }

        private static int foo21274911522740076(int p0, int p1) {
            return p0 * p1;
        }

        private static boolean foo21275688097945152(int p0, int p1) {
            return p0 < p1;
        }
