 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000056484::test1
...
public class c2fuzz000000056484 {
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000056484.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field1900() {
        ...
        v += field1909;
        {
            v += field1910;
            final int Ni323 = 32;
            for (int i323 = 1; i323 < Ni323; i323++) {
                v += field1910;
            }
        }
        v += field1911;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000056484.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
            ...
            for (int i6838 = 0; foo21274273588243635(i6838, M6838); i6838++) {
                {
                    ...
                    int toSinksnk3752 = 0;
                    {
                        ...
                        for (int j6838 = 0; foo21274181773278616(j6838, N6838); j6838++) {
                            ...
                            try {
                                    {
                                        toSinksnk1571 = 23 * (ysnk1571 - 1);
                                        final int Ni2336 = 32;
                                        for (int i2336 = 1; i2336 < Ni2336; i2336++) {
                                            toSinksnk1571 = 23 * (ysnk1571 - 1);
                                        }
                                    } } catch (ArithmeticException ex) { toSinksnk1571 ^= ex.hashCode(); }
                        }
