 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000082150::test1
...
public class c2fuzz000000082150 {
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000082150.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field0950() {
        ...
        for (int i3885 = 0; i3885 < Ni3885; i3885++) {
            if (foo21275080905394504(i3885, 10))
                v += field0972;
        ...
        for (int i4930 = 0; i4930 < M4930; i4930++) {
            {
                ...
                for (int j4930 = 0; j4930 < N4930; j4930++) {
                    ...
                    try { toSinksnk824 = foo21268339788775776(23, ysnk824, 1); } catch (ArithmeticException ex) { toSinksnk824 ^= ex.hashCode(); }
                }
    ...
    private static void test1_field1300() {
        ...
        int M6793 = 4;
        int N6793 = 8;
        for (int i6793 = 0; i6793 < M6793; i6793++) {
            for (int j6793 = 0; j6793 < N6793; j6793++) {
                switch (i6793) {
                    case -1, -2, -3 :
                        break;
                    case 0 :
    ...
    private static void test1_field1350() {
        ...
        v += field1374;
        {
            v += field1375;
            final int Ni4925 = 32;
            for (int i4925 = 1; i4925 < Ni4925; i4925++) {
                v += field1375;
            }
        }
        v += field1376;
    ...
    private static void test1_field2450() {
        ...
        v += field2474;
        {
            v += field2475;
            final int Ni8451 = 32;
            for (int i8451 = 1; i8451 < Ni8451; i8451++) {
                v += field2475;
            }
        }
        v += field2476;
    ...
    private static void test1_field3000() {
        ...
        {
            final int N3075 = 32;
            java.lang.Object object3075 = "hot";
            for (int i3075 = 0; i3075 < N3075; i3075++) {
                object3075.toString();
                if (i3075 == N3075 - 1)
                    v += field3038;

            }
            object3075 = java.lang.Integer.valueOf(1);
            object3075.toString();
            v += field3038;
        }
        v += field3039;
    ...
    private static void test1_field3100() {
        ...
        v += field3138;
        {
            v += field3139;
            final int Ni4801 = 32;
            for (int i4801 = 1; foo21274355004617787(i4801, Ni4801); i4801++) {
                v += field3139;
            }
        }
        v += field3140;
    ...
    private static void test1_field3250() {
        ...
        v += field3279;
        v += field3280;
        v += new MyInteger(c2fuzz000000082150.field3281).v();
        v += field3282;
        v += field3283;
        v += field3284;
        v += field3285;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000082150.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
            ...
            {
                {
                    this.v = v;
                    final int Ni4186 = 32;
                    for (int i4186 = 1; i4186 < Ni4186; i4186++) {
                        this.v = v;
                    }
                }
                final int Ni1456 = 32;
        ...
        public int v() {
            ...
            private static int foo21268339788775776(int p0, int p1, int p2) {
                return foo21275752151006225(p0, foo21274272216260301(p1, p2)) ;
            }
        ...
        private static int foo21274272216260301(int p0, int p1) {
            return foo21274792028655839(p0, p1);
        }

        private static boolean foo21274355004617787(int p0, int p1) {
            return p0 < p1;
        }

        private static int foo21274792028655839(int p0, int p1) {
            return p0 - p1;
        }

        private static boolean foo21275080905394504(int p0, int p1) {
            return p0 < p1;
        }

        private static int foo21275752151006225(int p0, int p1) {
            return p0 * p1;
        }
}
