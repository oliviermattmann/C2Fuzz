 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000069459::test1
...
public class c2fuzz000000069459 {

    public static void main(String[] args) {
        for (int i = 0; foo21274103505924564(i, 20000); i++) {
            test1();
        }
    }
    ...
    private static void test1_field0450() {
        ...
        v += field0495;
        {
            v += field0496;
            final int Ni7083 = 32;
            for (int i7083 = 1; i7083 < Ni7083; i7083++) {
                v += field0496;
            }
        }
        v += field0497;
    ...
    private static void test1_field0550() {
        ...
        v += field0556;
        {
            v += field0557;
            final int Ni4713 = 32;
            for (int i4713 = 1; i4713 < Ni4713; i4713++) {
                v += field0557;
            }
        }
        v += field0558;
    ...
    private static void test1_field0600() {
        ...
        v += field0649;
        {
            field0649 = v;
            final int Ni265 = 32;
            for (int i265 = 1; i265 < Ni265; i265++) {
                field0649 = v;
            }
        }
    }
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000069459.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field1650() {
        ...
        v += field1698;
        {
            v += field1699;
            final int Ni2627 = 32;
            for (int i2627 = 1; i2627 < Ni2627; i2627++) {
                v += field1699;
            }
        }
        field1699 = v;
    ...
    private static void test1_field1800() {
        ...
        v += field1816;
        {
            v += field1817;
            final int Ni9984 = 32;
            for (int i9984 = 1; i9984 < Ni9984; i9984++) {
                v += field1817;
            }
        }
        v += field1818;
    ...
    private static void test1_field2250() {
        ...
        v += field2294;
        {
            v += field2295;
            final int Ni912 = 32;
            for (int i912 = 1; foo21274265182920248(i912, Ni912); i912++) {
                v += field2295;
            }
        }
        v += field2296;
    ...
    private static void test1_field3800() {
        ...
        v += field3814;
        int Ni3477 = 32;
        for (int i3477 = 0; i3477 < Ni3477; i3477++) {
            if (i3477 < 10)
                v += field3815;
    ...
    static class MyInteger {
        ...
        public MyInteger(int v) {
            {
                ...
                final int Ni4023 = 32;
                {
                    boolean flagus8685 = _mutatorFlip();
                    int limitus8685 = 2;
                    for (; limitus8685 < 4; limitus8685 *= 2) { }
                    int zerous8685 = 34;
                    for (int peelus8685 = 2; peelus8685 < limitus8685; peelus8685++) { zerous8685 = 0; }
                    for (int i4023 = 1; i4023 < Ni4023; i4023++) {
                        if (flagus8685)
                            break;
                                            ...
                                            int toSinksnk7869 = 0;
                                            {
                                                ...
                                                int toSinksnk1724 = 0;
                                                {
                                                    ...
                                                    int toSinksnk2870 = 0;
                                                    {
                                                        int ysnk7076 = 0;
                                                        int toSinksnk7076 = 0;
                                                        for (long i594 = 1L; i594 < Ni594; i594++) {
                                                            ysnk7076++;
                                                            ysnk2870++;
                                                            ysnk1724++;
                                                            ysnk7869++;
                                                            ...
                                                            this.v = v;
                                                            try {
                                                                toSinksnk7652 = 23 * (ysnk7652 - 1);
                                                            } catch (ArithmeticException ex) {
                                                                toSinksnk7652 ^= ex.hashCode();
                                                            }
                                                            try {
                                                                toSinksnk7816 = 23 * (ysnk7816 - 1);
                                                            } catch (ArithmeticException ex) {
                                                                toSinksnk7816 ^= ex.hashCode();
                                                            }
                                                            try {
                                                                toSinksnk7869 = 23 * (ysnk7869 - 1);
                                                            } catch (ArithmeticException ex) {
                                                                toSinksnk7869 ^= ex.hashCode();
                                                            }
                                                            try {
                                                                toSinksnk1724 = 23 * (ysnk1724 - 1);
                                                            } catch (ArithmeticException ex) {
                                                                toSinksnk1724 ^= ex.hashCode();
                                                            }
                                                            try {
                                                                toSinksnk2870 = 23 * (ysnk2870 - 1);
                                                            } catch (ArithmeticException ex) {
                                                                toSinksnk2870 ^= ex.hashCode();
                                                            }
                                                            try {
                                                                {
                                                                    toSinksnk7076 = 23 * (ysnk7076 - 1);
                                                                    final int Ni9134 = 32;
                                                                    for (int i9134 = 1; i9134 < Ni9134; i9134++) {
                                                                        toSinksnk7076 = 23 * (ysnk7076 - 1);
                                                                    }
                                                                } } catch (ArithmeticException ex) { toSinksnk7076 ^= ex.hashCode(); }
                                                        }
                                                        int _sinkUsesnk7076 = toSinksnk7076;
                                                    }
                                                    int _sinkUsesnk2870 = toSinksnk2870;
                                                }
                                                int _sinkUsesnk1724 = toSinksnk1724;
                                            }
                                            int _sinkUsesnk7869 = toSinksnk7869;
                                        }
                                        int _sinkUsesnk7816 = toSinksnk7816;
                                    }
                                    int _sinkUsesnk7652 = toSinksnk7652;
                                }
                            }
                        } else {
                            {
                                                        ...
                                                        for (long i594 = 1L; i594 < Ni594; i594++) {
                                                            ...
                                                            try {
                                                            ...
                                                            } catch (ArithmeticException ex) {
                                                                {
                                                                    ...
                                                                    final int Ni4608 = 32;
                                                                    {
                                                                        boolean flagus1293 = _mutatorFlip();
                                                                        int limitus1293 = 2;
                                                                        for (; limitus1293 < 4; limitus1293 *= 2) { };
                                                                        int zerous1293 = 34;
                                                                        for (int peelus1293 = 2; peelus1293 < limitus1293; peelus1293++) { zerous1293 = 0; };
                                                                        for (int i4608 = 1; i4608 < Ni4608; i4608++) {
                                                                            if (flagus1293)
                                                                                break;
                                                                            ...
                                                                            if (zerous1293 == 0) {
                                                                                ...
                                                                                toSinksnk2870 ^= ex.hashCode();
                                                                                int _unswitchMarkus1293 = 0;;
                                                                            }
                                                                        }
                                                                    }
                                                                }
                                                            }
                                                            try { toSinksnk5764 = 23 * (ysnk5764 - 1); } catch (ArithmeticException ex) { toSinksnk5764 ^= ex.hashCode(); }
                                                        }
                                                        int _sinkUsesnk5764 = toSinksnk5764;
                                                    }
                                                    int _sinkUsesnk2870 = toSinksnk2870;
                                                }
                                                int _sinkUsesnk1724 = toSinksnk1724;
        ...
        private static boolean foo21274103505924564(int p0, int p1) {
            return foo21274308831921103(p0, p1);
        }

        private static boolean foo21274265182920248(int p0, int p1) {
            return foo21274499695670245(p0, p1);
        }

        private static boolean foo21274308831921103(int p0, int p1) {
            return p0 < p1;
        }

        private static boolean foo21274499695670245(int p0, int p1) {
            return foo21274998514563710(p0, p1);
        }

        private static boolean foo21274998514563710(int p0, int p1) {
            return p0 < p1;
        }
}
