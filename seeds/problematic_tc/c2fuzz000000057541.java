 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000057541::test1
...
public class c2fuzz000000057541 {
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000057541.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field1550() {
        ...
        v += field1560;
        {
            int limitlz2147 = 2;
            {
                boolean flagus7094 = _mutatorFlip();
                int limitus7094 = 2;
                for (; limitus7094 < 4; limitus7094 *= 2) { }
                int zerous7094 = 34;
                for (int peelus7094 = 2; foo21275129544204290(peelus7094, limitus7094); peelus7094++) { zerous7094 = 0; }
                for (; limitlz2147 < 4; limitlz2147 *= 2) {
                    if (flagus7094)
                        break;

                    if (foo21274905679041060(zerous7094, 0)) {
                    } else {
                        int _unswitchMarkus7094 = 0;;
                    }
                }
            }
            int zerolz2147 = 34;
            for (int peellz2147 = 2; peellz2147 < limitlz2147; peellz2147++) { zerolz2147 = 0; }
            if (foo21274483301808037(zerolz2147, 0)) {
                v += field1561;
            } else {
                v += field1561;
            }
    ...
    private static void test1_field2450() {
        ...
        v += field2499;
        {
            field2499 = v;
            final int Ni284 = 32;
            for (int i284 = 1; foo21274282037247594(i284, Ni284); i284++) {
                field2499 = v;
            }
        }
    }
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000057541.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
            ...
            {
                {
                    this.v = v;
                    final int Ni9213 = 32;
                    for (int i9213 = 1; i9213 < Ni9213; i9213++) {
                        this.v = v;
                    }
                }
                final int Ni1456 = 32;
                    ...
                    for (int peelus5668 = 2; peelus5668 < limitus5668; peelus5668++) {
                            {
                                zerous5668 = 0;
                                final int Ni692 = 32;
                                for (int i692 = 1; i692 < Ni692; i692++) {
                                    zerous5668 = 0;
                                }
                            } }
                        ...
                        if (zerous5668 == 0) {
                                {
                                    this.v = v;
                                    final int Ni246 = 32;
                                    for (int i246 = 1; i246 < Ni246; i246++) {
                                        this.v = v;
                                    }
                                }
                        } else {
        ...
        private static boolean foo21274282037247594(int p0, int p1) {
            return p0 < p1;
        }

        private static boolean foo21274483301808037(int p0, int p1) {
            return p0 == p1;
        }
        ...
        private static boolean foo21274905679041060(int p0, int p1) {
            return p0 == p1;
        }

        private static boolean foo21275129544204290(int p0, int p1) {
            return p0 < p1;
        }
}
