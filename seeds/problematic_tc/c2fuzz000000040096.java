 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000040096::test1
...
public class c2fuzz000000040096 {

    public static void main(String[] args) {
        for (int i = 0; foo21273413485919241(i, 20000); i++) {
            test1();
        }
    }
    ...
    private static void test1_field0500() {
        ...
        v += field0507;
        {
            v += field0508;
            final int Ni4513 = 32;
            for (int i4513 = 1; foo21275764333302740(i4513, Ni4513); i4513++) {
                v += field0508;
            }
        }
        v += field0509;
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000040096.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field3750() {
        ...
        {
            int limitlz2728 = 2;
            for (; limitlz2728 < 4; limitlz2728 *= 2) { }
            int zerolz2728 = 34;
            for (long peellz2728 = 2L; foo21274588518891551(peellz2728, limitlz2728); peellz2728++) { zerolz2728 = 0; }
            if (foo21276005974836483(zerolz2728, 0)) {
                v += field3753;
            } else {
                v += field3753;
            }
        ...
        v += field3772;
            {
                v += field3773;
                final int Ni3512 = 32;
                for (int i3512 = 1; foo21275231220932319(i3512, Ni3512); i3512++) {
                    v += field3773;
                }
            }
        v += field3774;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000040096.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
        ...
        public MyInteger(int v) {
            int Ni7448 = 32;
            {
                boolean flagus4694 = _mutatorFlip();
                int limitus4694 = 2;
                for (; limitus4694 < 4; limitus4694 *= 2) { }
                int zerous4694 = 34;
                for (int peelus4694 = 2; peelus4694 < limitus4694; peelus4694++) { zerous4694 = 0; }
                for (int i7448 = 0; i7448 < Ni7448; i7448++) {
                    ...
                    if (zerous4694 == 0) {
                        if (i7448 < 10) {
                            {
                                final int N2096 = 32;
                                java.lang.Object object2096 = "hot";
                                for (int i2096 = 0; i2096 < N2096; i2096++) {
                                    object2096.toString();
                                    if (i2096 == N2096 - 1)
                                        this.v = v;

                                }
                                object2096 = java.lang.Integer.valueOf(1);
                                object2096.toString();
                                this.v = v;
                            }
                        }
                        ...
                        int _unswitchMarkus4694 = 0;;
                    }
                }
            }
            {
                    int Ni3864 = 32;
                    for (int i3864 = 0; i3864 < Ni3864; i3864++) {
                        if (i3864 < 10)
                            this.v = v;
                    ...
                    this.v = v;
                final int Ni6866 = 32;
                for (long i6866 = 1L; i6866 < Ni6866; i6866++) {
                    this.v = v;
                }
            }
        }
        ...
        private static boolean foo21273413485919241(int p0, int p1) {
            return p0 < p1;
        }

            private static boolean foo21274588518891551(long p0, int p1) {
                return p0 < p1;
            }

            private static boolean foo21275231220932319(int p0, int p1) {
                return p0 < p1;
            }

        private static boolean foo21275764333302740(int p0, int p1) {
            return p0 < p1;
        }

            private static boolean foo21276005974836483(int p0, int p1) {
                return p0 == p1;
            }
}
