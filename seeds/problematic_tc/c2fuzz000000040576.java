 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000040576::test1
...
public class c2fuzz000000040576 {
    ...
    private static void test1_field0050() {
        int v = field0050;
        {
            v += field0051;
            final int Ni5706 = 32;
            for (int i5706 = 1; foo21276091265443699(i5706, Ni5706); i5706++) {
                v += field0051;
            }
        }
        v += field0052;
    ...
    private static void test1_field0850() {
        ...
        v += field0891;
        {
            v += field0892;
            final int Ni7338 = 32;
            for (int i7338 = 1; i7338 < Ni7338; i7338++) {
                v += field0892;
            }
        }
        v += field0893;
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000040576.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000040576.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
                                ...
                                int toSinksnk7669 = 0;
                                {
                                    ...
                                    int toSinksnk3021 = 0;
                                    {
                                        ...
                                        for (int j6838 = 0; j6838 < N6838; j6838++) {
                                            ...
                                            try {
                                                toSinksnk5635 = 23 * (ysnk5635 - 1);
                                            } catch (ArithmeticException ex) {
                                                toSinksnk5635 ^= ex.hashCode();
                                            }
                                            try {
                                                toSinksnk7669 = 23 * (ysnk7669 - 1);
                                            } catch (ArithmeticException ex) {
                                                toSinksnk7669 ^= ex.hashCode();
                                            }
                                            try {
                                                toSinksnk3021 = 23 * (ysnk3021 - 1);
                                            } catch (ArithmeticException ex) {
                                                toSinksnk3021 ^= ex.hashCode();
                                            }
                                            try { toSinksnk6096 = 23 * (ysnk6096 - 1); } catch (ArithmeticException ex) { toSinksnk6096 ^= ex.hashCode(); };
                                        }
                                        int _sinkUsesnk6096 = toSinksnk6096;;
                                    }
                                    int _sinkUsesnk3021 = toSinksnk3021;
                                }
                                int _sinkUsesnk7669 = toSinksnk7669;
                            }
                            int _sinkUsesnk5635 = toSinksnk5635;
                        }
        ...
        private static boolean foo21276091265443699(int p0, int p1) {
            return p0 < p1;
        }
}
