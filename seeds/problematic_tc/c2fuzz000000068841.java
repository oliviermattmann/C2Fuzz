 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000068841::test1
...
public class c2fuzz000000068841 {
    ...
    private static void test1_field0850() {
        ...
        v += field0891;
        {
            v += field0892;
            final int Ni7338 = 32;
            for (long i7338 = 1L; i7338 < Ni7338; i7338++) {
                v += field0892;
            }
        }
        v += field0893;
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000068841.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field2800() {
        ...
        v += field2819;
        int Ni1320 = 32;
        for (int i1320 = 0; i1320 < Ni1320; i1320++) {
            if (i1320 < 10)
                v += field2820;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000068841.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
                                    ...
                                    try {
                                            {
                                                ...
                                                final int Ni5499 = 32;
                                                for (int i5499 = 1; i5499 < Ni5499; i5499++) {
                                                    toSinksnk7669 = 23 * (ysnk7669 - 1);
                                                }
                                            } } catch (ArithmeticException ex) { toSinksnk7669 ^= ex.hashCode(); }
                                }
