 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000040528::test1
...
public class c2fuzz000000040528 {

    public static void main(String[] args) {
        for (int i = 0; foo21275355311737469(i, 20000); i++) {
            test1();
        }
    }
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000040528.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field1250() {
        ...
        {
            int limitlz3574 = 2;
            for (; limitlz3574 < 4; limitlz3574 *= 2) { };
            int zerolz3574 = 34;
            for (int peellz3574 = 2; peellz3574 < limitlz3574; peellz3574++) { zerolz3574 = 0; };
            if (zerolz3574 == 0) {
                v += field1289;
            } else {
                v += field1289;
    ...
    private static void test1_field3450() {
        synchronized(c2fuzz000000040528.class) {
            int v = field3450;
            v += field3451;
            v += field3452;
            v += field3453;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000040528.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
        ...
        private static boolean foo21268672930464430(int p0, int p1) {
            return foo21275998389872687(p0, p1);
        }
        ...
        private static boolean foo21275355311737469(int p0, int p1) {
            return foo21275758458320066(p0, p1);
        }

        private static boolean foo21275758458320066(int p0, int p1) {
            return p0 < p1;
        }

        private static boolean foo21275998389872687(int p0, int p1) {
            return p0 < p1;
        }
}
