 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000077200::test1
...
public class c2fuzz000000077200 {
    ...
    private static void test1_field0050() {
        ...
        v += field0074;
        v += field0075;
        v += new MyInteger(c2fuzz000000077200.field0076).v();
        v += field0077;
        v += field0078;
        v += field0079;
        v += field0080;
    ...
    private static void test1_field0500() {
        ...
        v += field0507;
        {
            v += field0508;
            final int Ni4513 = 32;
            for (int i4513 = 1; i4513 < Ni4513; i4513++) {
                v += field0508;
            }
        }
        v += field0509;
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000077200.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field1200() {
        ...
        v += field1205;
        {
            v += field1206;
            final int Ni4402 = 32;
            for (int i4402 = 1; foo21274563816906799(i4402, Ni4402); i4402++) {
                v += field1206;
            }
        }
        v += field1207;
    ...
    private static void test1_field1300() {
        ...
        v += field1348;
        {
            v += field1349;
            final int Ni7205 = 32;
            for (int i7205 = 1; i7205 < Ni7205; i7205++) {
                v += field1349;
            }
        }
        field1349 = v;
    ...
    private static void test1_field2650() {
        ...
        {
            final int N7640 = 32;
            java.lang.Object object7640 = "hot";
            for (int i7640 = 0; i7640 < N7640; i7640++) {
                object7640.toString();
                if (i7640 == N7640 - 1)
                    v += field2672;

            }
            object7640 = java.lang.Integer.valueOf(1);
            object7640.toString();
            v += field2672;
        }
        v += field2673;
    ...
    private static void test1_field3400() {
        ...
        v += field3421;
        {
            v += field3422;
            final int Ni6766 = 32;
            for (int i6766 = 1; i6766 < Ni6766; i6766++) {
                v += field3422;
            }
        }
        v += field3423;
    ...
    private static void test1_field3450() {
        ...
        v += field3475;
        {
            v += field3476;
            final int Ni1933 = 32;
            for (int i1933 = 1; i1933 < Ni1933; i1933++) {
                v += field3476;
            }
        }
        v += field3477;
    ...
    private static void test1_field3750() {
        ...
        v += field3752;
        {
            ...
            int zerolz2728 = 34;
            for (int peellz2728 = 2; foo21273575809098973(peellz2728, limitlz2728); peellz2728++) { zerolz2728 = 0; }
            if (zerolz2728 == 0) {
                v += field3753;
            } else {
                v += field3753;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000077200.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
        ...
        public MyInteger(int v) {
            ...
            for (int i7448 = 0; i7448 < Ni7448; i7448++) {
                if (i7448 < 10)
                    this.v = java.lang.Integer.valueOf(v);
            ...
            {
                {
                    int M6061 = 4;
                    int N6061 = 8;
                    for (int i6061 = 0; i6061 < M6061; i6061++) {
                        for (int j6061 = 0; j6061 < N6061; j6061++) {
                            switch (i6061) {
                                case -1, -2, -3 :
                                    break;
                                case 0 :
                    ...
                    this.v = v;
                    final int Ni5934 = 32;
                    for (int i5934 = 1; i5934 < Ni5934; i5934++) {
                        this.v = v;
                    }
                }
                final int Ni6866 = 32;
                for (int i6866 = 1; i6866 < Ni6866; i6866++) {
                        {
                            this.v = v;
                            final int Ni7231 = 32;
                            for (int i7231 = 1; i7231 < Ni7231; i7231++) {
                                this.v = v;
                            }
                        }
                }
        ...
        private static boolean foo21273575809098973(int p0, int p1) {
            return p0 < p1;
        }

        private static boolean foo21274563816906799(int p0, int p1) {
            return foo21275007900338431(p0, p1);
        }

        private static boolean foo21275007900338431(int p0, int p1) {
            return p0 < p1;
        }
}
