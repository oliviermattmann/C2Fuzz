 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000044345::test1
...
public class c2fuzz000000044345 {
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000044345.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field2600() {
        ...
        int M4245 = 4;
        int N4245 = 8;
        for (int i4245 = 0; i4245 < M4245; i4245++) {
            for (int j4245 = 0; j4245 < N4245; j4245++) {
                switch (i4245) {
                    case -1, -2, -3 :
                        break;
                    case 0 :
    ...
    private static void test1_field3400() {
        ...
        v += field3427;
        {
            v += field3428;
            final int Ni9787 = 32;
            for (int i9787 = 1; i9787 < Ni9787; i9787++) {
                v += field3428;
            }
        }
        v += field3429;
    ...
    static class MyInteger {
                                                ...
                                                int toSinksnk1724 = 0;
                                                {
                                                    ...
                                                    int toSinksnk2870 = 0;
                                                    {
                                                        ...
                                                        for (long i594 = 1L; i594 < Ni594; i594++) {
                                                            ...
                                                            try { toSinksnk7076 = 23 * (ysnk7076 - 1); } catch (ArithmeticException ex) { toSinksnk7076 ^= ex.hashCode(); };
                                                        }
                                                    ...
                                                    int toSinksnk2870 = 0;
                                                    {
                                                        ...
                                                        int toSinksnk5764 = 0;
                                                        {
                                                            ...
                                                            for (long i594 = 1L; i594 < Ni594; i594++) {
                                                                ...
                                                                try {
                                                                    toSinksnk5764 = 23 * (ysnk5764 - 1);
                                                                } catch (ArithmeticException ex) {
                                                                    toSinksnk5764 ^= ex.hashCode();
                                                                }
                                                                try { toSinksnk6028 = 23 * (ysnk6028 - 1); } catch (ArithmeticException ex) { toSinksnk6028 ^= ex.hashCode(); };
                                                            }
                                                            int _sinkUsesnk6028 = toSinksnk6028;;
                                                        }
        ...
        private static boolean foo21274308831921103(int p0, int p1) {
            return foo21274701641150565(p0, p1);
        }
        ...
        private static boolean foo21274701641150565(int p0, int p1) {
            return p0 < p1;
        }
}
