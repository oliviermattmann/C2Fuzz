 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000061731::test1
...
public class c2fuzz000000061731 {

    public static void main(String[] args) {
        for (int i = 0; foo21274282669517917(i, 20000); i++) {
            test1();
        }
    }
    ...
    private static void test1_field0550() {
        ...
        v += field0575;
        v += field0576;
        v += new MyInteger(c2fuzz000000061731.field0577).v();
        v += field0578;
        v += field0579;
        v += field0580;
        v += field0581;
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000061731.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field1350() {
        synchronized(c2fuzz000000061731.MyInteger.class) {
            int v = field1350;
            v += field1351;
            v += field1352;
            v += field1353;
    ...
    private static void test1_field2150() {
        ...
        {
            final int N6701 = 32;
            java.lang.Object object6701 = "hot";
            for (int i6701 = 0; i6701 < N6701; i6701++) {
                object6701.toString();
                if (i6701 == N6701 - 1)
                    v += field2164;

            }
            object6701 = java.lang.Integer.valueOf(1);
            object6701.toString();
            v += field2164;
        }
        v += field2165;
    ...
    private static void test1_field2450() {
        ...
        v += field2464;
        {
            v += field2465;
            final int Ni2740 = 32;
            for (int i2740 = 1; i2740 < Ni2740; i2740++) {
                v += field2465;
            }
        }
        v += field2466;
        ...
        v += field2499;
        {
            field2499 = v;
            final int Ni284 = 32;
            for (int i284 = 1; foo21274679102659645(i284, Ni284); i284++) {
                field2499 = v;
            }
        }
    }
    ...
    private static void test1_field2800() {
        ...
        v += field2841;
        {
            v += field2842;
            final int Ni4779 = 32;
            for (int i4779 = 1; i4779 < Ni4779; i4779++) {
                v += field2842;
            }
        }
        v += field2843;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000061731.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    private static void test1_field3950() {
        ...
        v += field3993;
        v += field3994;
        v += java.lang.Integer.valueOf(field3995);
        v += field3996;
        v += field3997;
        v += field3998;
        v += field3999;
    ...
    static class MyInteger {
        ...
        public MyInteger(int v) {
            ...
            }
            {
                ...
                for (int i1456 = 1; i1456 < Ni1456; i1456++) {
                    int Ni7303 = 32;
                    for (int i7303 = 0; i7303 < Ni7303; i7303++) {
                        if (i7303 < 10)
                            this.v = v;
        ...
        private static boolean foo21274282669517917(int p0, int p1) {
            return foo21275161086474152(p0, p1);
        }

        private static boolean foo21274679102659645(int p0, int p1) {
            return p0 < p1;
        }

        private static boolean foo21275161086474152(int p0, int p1) {
            return p0 < p1;
        }
}
