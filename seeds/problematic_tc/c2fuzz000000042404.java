 ...
 * @run main/othervm/timeout=480 -XX:CompileOnly=c2fuzz000000042404::test1
...
public class c2fuzz000000042404 {

    public static void main(String[] args) {
        for (int i = 0; foo21275109452576637(i, 20000); i++) {
            test1();
        }
    }
    ...
    private static void test1_field0900() {
        ...
        v += field0927;
        v += field0928;
        v += new MyInteger(c2fuzz000000042404.field0929).v();
        v += field0930;
        v += field0931;
        v += field0932;
        v += field0933;
    ...
    private static void test1_field3900() {
        ...
        v += field3916;
        v += field3917;
        v += new MyInteger(c2fuzz000000042404.field3918).v();
        v += field3919;
        v += field3920;
        v += field3921;
        v += field3922;
    ...
    static class MyInteger {
            ...
            {
                {
                    this.v = v;
                    final int Ni9409 = 32;
                    for (int i9409 = 1; i9409 < Ni9409; i9409++) {
                        this.v = v;
                    }
                }
                final int Ni1456 = 32;
            ...
            for (int i6838 = 0; foo21274273588243635(i6838, M6838); i6838++) {
                {
                    ...
                    for (int j6838 = 0; foo21274181773278616(j6838, N6838); j6838++) {
                        ...
                        try { toSinksnk3752 = 23 * (ysnk3752 - 1); } catch (ArithmeticException ex) { toSinksnk3752 ^= ex.hashCode(); };
                    }
        ...
        private static boolean foo21275109452576637(int p0, int p1) {
            return p0 < p1;
        }
}
