 ...
 *
 * @run main/othervm -XX:-TieredCompilation -XX:-BackgroundCompilation -XX:-UseOnStackReplacement -XX:CompileCommand=dontinline,c2fuzz000000004314::not_inlined  c2fuzz000000004314
 *
 */

public class c2fuzz000000004314 {
    ...
    static class MyInteger {
        ...
        public MyInteger(int v) {
            int Ni3375 = 32;
            for (int i3375 = 0; i3375 < Ni3375; i3375++) {
                if (i3375 < 10)
                    this.v = v;
