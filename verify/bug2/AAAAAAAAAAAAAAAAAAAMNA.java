 ...
 *
 * @run main/othervm -XX:-BackgroundCompilation -XX:-UseOnStackReplacement -XX:+UnlockDiagnosticVMOptions -XX:+IgnoreUnrecognizedVMOptions -XX:+StressGCM -XX:+StressLCM AAAAAAAAAAAAAAAAAAAMNA
 *
 */

import java.util.Arrays;

public class AAAAAAAAAAAAAAAAAAAMNA {
    ...
    static int test1(int[] src) {
        ...
        int M9037 = 16;
        int N9037 = 32;
        for (int i9037 = 0; i9037 < M9037; i9037++) {
            for (int j9037 = 0; j9037 < N9037; j9037++) {
                switch (i9037) {
                    case -1, -2, -3 :
                        break;
                    case 0 :
