 ...
 * @run main/othervm -XX:-BackgroundCompilation c2fuzz000000080449
 */

public class c2fuzz000000080449 {
    long instanceCount;
    int iFld;
                                ...
                                for (int peellz6086 = 2; peellz6086 < limitlz6086; peellz6086++) {
                                    {
                                        zerolz6086 = 0;
                                        final int Ni5978 = 32;
                                        for (int i5978 = 1; i5978 < Ni5978; i5978++) {
                                            zerolz6086 = 0;
                                        }
                                    } }
                                if (zerolz6086 == 0) {
                        ...
                        final int Ni7801 = 32;
                            {
                                ...
                                int zerous2549 = 34;
                                for (int peelus2549 = 2; peelus2549 < limitus2549; peelus2549++) { zerous2549 = 0; }
                                {
                                    boolean flagus326 = _mutatorFlip();
                                    int limitus326 = 2;
                                    for (; limitus326 < 4; limitus326 *= java.lang.Integer.valueOf(2) ) { }
                                    int zerous326 = 34;
                                    for (int peelus326 = 2; peelus326 < limitus326; peelus326++) { zerous326 = 0; }
    ...
    public static void main(String[] strArr) {
        c2fuzz000000080449 _instance = new c2fuzz000000080449();
        ...
        public MyInteger(int v) {
            ...
            for (int i1958 = 0; i1958 < Ni1958; i1958++) {
                if (i1958 < 10)
                    ...
                    {
                        int limitlz150 = 2;
                        for (; limitlz150 < 4; limitlz150 *= 2) { };
                        int zerolz150 = 34;
                        for (int peellz150 = 2; peellz150 < limitlz150; peellz150++) { zerolz150 = 0; };
                        if (zerolz150 == 0) {
                            this.v = v;
                        } else {
                            this.v = v;
