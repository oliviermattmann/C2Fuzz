...
public class LoopPeelingMutator implements Mutator {
    private final Random random;
    private static final Logger LOGGER = LoggingConfig.getLogger(LoopPeelingMutator.class);

    public LoopPeelingMutator(Random random) { this.random = random; }
    ...
    public MutationResult mutate(MutationContext ctx) {
        ...
        if (candidates.isEmpty()) {
            return new MutationResult(MutationStatus.SKIPPED, ctx.launcher(), "No assignments found for LoopPeeling");
        }
